  ...
  module Logic
    class Fetcher
      ...
      module SpecHelper
        ...
        # единственный файл вида `lib/<name>.rb`, где `<name>` —
        # предоставленное название библиотеки. В файле определяется Ruby-модуль
        # с названием, совпадающим с названием библиотеки в ВерблюжьемРегистре.
        # В этом Ruby-модуле определяется единственная константа `VERSION` со
        # значением, которое равно строке с предоставленной версией.
        # @param [String] name
        #   название библиотеки
        ...
        # Создаёт и возвращает тело TAR-архива, в котором файла `data.tar.gz`
        # не представляет собой Gzip-архив
        # @return [String]
        #   тело результирующего TAR-архива
        ...
        # Создаёт TAR-архив на основе информации предоставленного
        # ассоциативного массива, ключи которого являются именами файлов, а
        # значения — телами этих файлов, и возвращает тело созданного
        # TAR-архива
