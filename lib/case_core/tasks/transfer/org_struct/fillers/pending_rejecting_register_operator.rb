    ...
    class Transfer
      module OrgStruct
        ...
        module Fillers
          ...
          # оператору, поместившему невостребованный результат оказания услуги
          # в реестр передаваемой корреспонденции
          class PendingRejectingRegisterOperator < Base::Filler
            ...
            def initialize(os_db, mfc_db, c4s3, memo)
              operator_id = c4s3['pending_rejecting_register_operator_id']
            ...
            NAMES = {
              first_name:  'pending_rejecting_register_operator_name',
              middle_name: 'pending_rejecting_register_operator_middle_name',
              last_name:   'pending_rejecting_register_operator_surname',
              position:    'pending_rejecting_register_operator_position'
            }.freeze
