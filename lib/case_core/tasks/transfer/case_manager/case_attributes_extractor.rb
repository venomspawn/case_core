...
module CaseCore
  module Tasks
    class Transfer
      module CaseManager
        # Класс объектов, предоставляющих возможность извлечения информации об
        # атрибутах заявки для импорта
        class CaseAttributesExtractor
          ...
          def register_id_name
            rejected? ? 'pending_rejecting_register_id' : 'pending_register_id'
          end
